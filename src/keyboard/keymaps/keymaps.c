...
const DefaultBind default_binds[] = {
    ...
    {XK_h, DEFAULT_MOD | ALT, action_move_win_monitor_down},
    {XK_j, DEFAULT_MOD | ALT, action_move_win_monitor_left},
    {XK_k, DEFAULT_MOD | ALT, action_move_win_monitor_up},
    {XK_l, DEFAULT_MOD | ALT, action_move_win_monitor_right},
    {XK_h, DEFAULT_MOD | SHIFT, action_win_move_down},
    {XK_j, DEFAULT_MOD | SHIFT, action_win_move_up},
    {XK_k, DEFAULT_MOD | SHIFT, action_win_move_left},
    {XK_l, DEFAULT_MOD | SHIFT, action_win_move_right},
    {XK_m, DEFAULT_MOD, action_enter_resize},
    {XK_m, DEFAULT_MOD, action_exit_resize},
    {XK_h, DEFAULT_MOD | CONTROL, action_resize_down},
    {XK_j, DEFAULT_MOD | CONTROL, action_resize_up},
    {XK_k, DEFAULT_MOD | CONTROL, action_resize_left},
